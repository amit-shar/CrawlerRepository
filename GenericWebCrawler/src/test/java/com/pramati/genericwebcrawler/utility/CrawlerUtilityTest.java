...
public class CrawlerUtilityTest {
	...
	@Test
	public void convertHtmlToStringTest_UrlException()
			throws MalformedURLException {
		URL urlTOCrawl = new URL(
				"http://google.com/maven-users/201503.mbox/raw/");
		URL url = new URL(
				"http://maven-users.archives/mod_mbox/maven-users/201503.mbox/raw/");
