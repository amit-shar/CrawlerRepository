...
public class EmailFilterRuleTest {
	...
	public void filterCriteriatest() {
		...
		assertTrue(emailFilterRuleObj
				.filterCriteria("/mod_mbox/maven-users/201503.mbox/"));
		assertFalse(emailFilterRuleObj
				.filterCriteria("/mod_mbox/maven-users/20103.mbox/raw"));
	...
	public void exitCriteriaTest() {
		...
		assertTrue(emailFilterRuleObj
				.exitCriteria("/mod_mbox/maven-users/20103.mbox/raw/"));
		assertFalse(emailFilterRuleObj
				.exitCriteria("/mod_mbox/maven-users/201503.mbox/"));
	}

	@Test
	public void getDateTest() {
		String expectedOutput = emailFilterRuleObj
				.getDate("fhgdshfgdhsj Date: 02, Mar, 2015");
	...
	public void getSubjectTest() {
		String expectedOutput = emailFilterRuleObj
				.getSubject("fhgdshf@%^gdhsj Subject: This is a test case");
	...
	public void getSenderTest() {
		String expectedOutput = emailFilterRuleObj
				.getSender("fhgdshfgdhsj From: john@abc.com");
